	...
	implements DebugLifecycleComponent
{
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		renderFacility(graphics, Color.BLUE, "sailPattern", boat.getSailPattern(), boat.getSailPatternObject());
		renderFacility(graphics, Color.CYAN, "sailMast", boat.getSailMast(), boat.getSailMastObject());
