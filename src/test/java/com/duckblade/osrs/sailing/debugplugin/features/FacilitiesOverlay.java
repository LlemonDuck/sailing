	...
	implements DebugLifecycleComponent
{
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		renderFacility(graphics, Color.BLUE, "sail", boat.getSail(), boat.getSailObject());
		renderFacility(graphics, Color.CYAN, "sailTier", boat.getSailTier(), boat.getSailTierObject());
