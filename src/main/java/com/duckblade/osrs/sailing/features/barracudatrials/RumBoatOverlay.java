		...
		implements PluginLifecycleComponent
{
	...
	{
		rumBoatColour = config.barracudaHighlightTemporTantrumRumBoatColour();
	...
	public void onGameObjectSpawned(GameObjectSpawned e)
	{
		...
		if (o.getId() == TEMPOR_TANTRUM_RUM_BOAT_HULL_OBJECT)
		{
	...
	public Dimension render(Graphics2D g)
	{
		...
		for (GameObject o : rumBoatObjects)
		{
			...
			if (shouldHighlight(o))
			{
				...
				if (convexHull != null)
				{
					OverlayUtil.renderPolygon(g, convexHull, rumBoatColour);
				}
			}
		}
