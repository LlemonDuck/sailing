		...
		implements PluginLifecycleComponent
{
	...
	private Color dangerousRapidsColor;
	private Color unknownRapidsColor;
	...
	public boolean isEnabled(SailingConfig config)
	{
		...
		dangerousRapidsColor = config.dangerousRapidsColor();
		unknownRapidsColor = config.unknownRapidsColor();
