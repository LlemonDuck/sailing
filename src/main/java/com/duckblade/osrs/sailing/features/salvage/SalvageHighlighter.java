        ...
        implements PluginLifecycleComponent
{
    ...
    {
        salvageHighlightColor = config.salvageHighlightColor();
        salvageHighlightSunkColor = config.salvageHighlightSunkColor();
        salvageHighlightNotLevelColor = config.salvageHighlightNotLevelColor();
        return config.salvageHighlight();
    }
    ...
    {
        if (!SailingUtil.isSailing(client) || !config.salvageHighlight())
        {
            return null;
        }
